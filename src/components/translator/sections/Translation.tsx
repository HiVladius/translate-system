...
export const Translation = () => {
  ...
  const addNewRow = () => {
    ...
    if (addButtonRef.current) {
      ...
      addButtonRef.current.style.opacity = "0.5";
      addButtonRef.current.style.cursor = "not-allowed";
    }
  };
            ...
            <tr key={row.id}>
              <td style={tdStyle as React.CSSProperties}>
                <input
                  ...
                  onKeyDown={(e) => handleTabKey(e, rowIndex, 0)}
              ...
              <td style={tdStyle as React.CSSProperties}>
                <input
                  ...
                  onKeyDown={(e) => handleTabKey(e, rowIndex, 1)}
                />
              </td>
              <td style={tdStyle as React.CSSProperties}>
                <textarea
